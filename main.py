...
from dataloader import load_data, create_dictionaries, \
...
def main():
    model = Seq2Seq(input_dim=40, vocab_size=len(LETTER_LIST), hidden_dim=128, value_size=128,
                    key_size=256, is_attended=True)
    ...
    train_loader = DataLoader(train_dataset, batch_size=batch_size, shuffle=False, collate_fn=collate_train)
    # val_loader =
